        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-coral transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-coral transition-colors">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-coral transition-colors">
          ...
          {/* Categorii */}
          <div>
            <h3 className="font-bold mb-4 text-sm uppercase tracking-wider text-white">Categorii</h3>
          ...
          {/* Informații */}
          <div>
            <h3 className="font-bold mb-4 text-sm uppercase tracking-wider text-white">Informații</h3>
            <ul className="space-y-2.5 text-sm text-gray-400">
              <li>
                <Link href="/despre-noi" className="hover:text-coral transition-colors">
                  Despre noi
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/informatii-livrare" className="hover:text-coral transition-colors">
                  Informații livrare
                </Link>
              </li>
              <li>
                <Link href="/intrebari-frecvente" className="hover:text-coral transition-colors">
                  Întrebări frecvente
                </Link>
              </li>
            </ul>
          ...
          {/* Legal */}
          <div>
            <h3 className="font-bold mb-4 text-sm uppercase tracking-wider text-white">Legal</h3>
            <ul className="space-y-2.5 text-sm text-gray-400">
              <li>
              ...
              <li>
                <Link href="/politica-confidentialitate" className="hover:text-coral transition-colors">
                  Politica de confidențialitate
                </Link>
              </li>
              <li>
                <Link href="/politica-cookies" className="hover:text-coral transition-colors">
                  Politica de cookies
                </Link>
              </li>
              <li>
                <Link href="/politica-retur" className="hover:text-coral transition-colors">
                  Politica de retur
                </Link>
              </li>
            </ul>
